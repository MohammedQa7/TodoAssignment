  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: TabBarView(
            children: [
              AllTasksScreen(changeTaskCompleteness,removeItem),
              CompleteTasksScreen(changeTaskCompleteness,removeItem,),
              InCompleteTasksScreen(changeTaskCompleteness,removeItem)
            ],
          ),
        ));
  }
